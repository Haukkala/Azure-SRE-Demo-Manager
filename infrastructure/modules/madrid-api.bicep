...
output apiUrl string = (deployVM && createPublicIp) ? 'http://${publicIp!.properties.dnsSettings.fqdn}:3002' : (deployVM ? 'http://${nic!.properties.ipConfigurations[0].properties.privateIPAddress}:3002' : '')
